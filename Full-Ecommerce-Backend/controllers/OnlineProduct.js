...
exports.GetProducts = async (req, res) => {
  try {
    ...
    let query = OnlineProduct.find(filter);
    ...
    const totalProducts = await OnlineProduct.countDocuments(filter);
...
exports.UpdateProduct = async (req, res) => {
  try {
    ...
    const updatedProduct = await OnlineProduct.findByIdAndUpdate(req.params.id, updateData, { new: true, runValidators: true });
...
exports.DeleteProduct = async (req,res)=>{
    try{
        await OnlineProduct.findByIdAndDelete(req.params.id)
...
exports.GetProduct = async (req,res)=>{
    try{
        const GetProduct = await OnlineProduct.findById(req.params.id)
        if(!GetProduct){
