...
const FeaturedAddProduct = () => {
  ...
  <h2 className="add-product-title">إضافة منتج مميز جديد</h2>
  <form className="add-product-form" onSubmit={handleSubmit}>
    ...
    <div className="form-grid">
      ...
      <div className="form-group">
        <label>الخصم</label>
        <input type="number" value={discount} onChange={(e) => setDiscount(e.target.value)} placeholder="أدخل قيمة الخصم" />
      </div>
    </div>

    <div className="form-group">
      <label>القسم</label>
      <input type="text" value={category} onChange={(e) => setCategory(e.target.value)} placeholder="أدخل القسم" required />
    </div>
